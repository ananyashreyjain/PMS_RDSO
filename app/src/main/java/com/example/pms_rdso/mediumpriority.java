...
public class mediumpriority extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProjectAdapter adapter = new ProjectAdapter(this, projects, R.color.category_medium_priority);
        ...
        projectNameTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent projectNameIntent = new Intent(mediumpriority.this, CreateNewProject.class);
